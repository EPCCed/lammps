...
PairStyle(shresquared,PairSHRESquared)

#else

#ifndef LMP_PAIR_SHRESQUARED_H
#define LMP_PAIR_RSHESQUARED_H

#include "pair.h"

namespace LAMMPS_NS {

class PairSHRESquared : public Pair {
 public:
  PairSHRESquared(LAMMPS *lmp);
  virtual ~PairSHRESquared();
...
//  class AtomVecEllipsoid *avec;
  class AtomVecSpherharmUnitTests *avec;
  ...
  int shape_consistency(int itype, double &shapex, double &shapey, double &shapez);
