...
void Atom::peratom_create()
{
  ...
  add_peratom("ab_area",&ab_area,DOUBLE,0);
  add_peratom("normal",&normal,DOUBLE,3);
...
void *Atom::extract(const char *name)
{
  ...
  if (strcmp(name,"ab_area") == 0) return (void *) ab_area;
  if (strcmp(name,"normal") == 0) return (void *) normal;
...
int Atom::extract_datatype(const char *name)
{
  ...
  if (strcmp(name,"ab_area") == 0) return LAMMPS_DOUBLE;
  if (strcmp(name,"normal") == 0) return LAMMPS_DOUBLE_2D;
